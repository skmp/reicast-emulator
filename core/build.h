...
// Compiler Related
#define COMPILER_GNU ((BUILD_COMPILER == COMPILER_GCC) || (BUILD_COMPILER == COMPILER_CLANG))
#define COMPILER_VC_OR_CLANG_WIN32 ((BUILD_COMPILER == COMPILER_VC) || (BUILD_COMPILER == COMPILER_CLANG) && _WIN32)
...
#define RAM_SIZE_MAX (32*1024*1024)		// MB(32)
#define VRAM_SIZE_MAX (16*1024*1024)	// MB(16)
#define ARAM_SIZE_MAX (8*1024*1024)		// MB(8)
