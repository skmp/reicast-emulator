...
#include <sys/mman.h>
#include <sys/time.h>
#if !defined(_ANDROID) && !defined(TARGET_IPHONE) && !defined(TARGET_NACL32) && !defined(TARGET_EMSCRIPTEN) && !defined(TARGET_OSX) && !defined(TARGET_IPHONE_SIMULATOR)
...
void linux_fix_personality() {
        #if HOST_OS == OS_LINUX && !defined(_ANDROID) && !defined(TARGET_IPHONE) && !defined(TARGET_IPHONE_SIMULATOR) && !defined(TARGET_NACL32) && !defined(TARGET_EMSCRIPTEN)
