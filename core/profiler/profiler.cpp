...
void prof_periodical()
{
	...
	wprintf(L"TA_VTXC %d,TA_SPRC %d,TA_EOSC %d,TA_PPC %d,TA_SPC %d,TA_EOLC %d,TA_V64HC %d\n", TA_VTXC,TA_SPRC,TA_EOSC,TA_PPC,TA_SPC,TA_EOLC,TA_V64HC);
	...
	wprintf(L"Ret cache: %.2fM rets, %.2f:1 HRD, %.2f:1 HRS, %.2f:1 DSR, %.0f fails, %.2f:1 HRAll\n",
	...
	{
		wprintf(L"***PROFILE REPORT***\n");
		prof.counters.print();
	}

	wprintf(L"opcode fallbacks:\n");
