//Yep, this is a duplicate of rec-ARM/arm_dyna.cpp.  I needed to push the mac stuff to a different folder so I could have Raspberry Pi 2 possible to compile.
#include <unistd.h>
#include <sys/mman.h>
#include "types.h"
