...
struct Arm7Context
{
	...
	u8 (*read8)(Arm7Context* ctx, u32 addr);
	u32 (*read32)(Arm7Context* ctx, u32 addr);
	
	void (*write8)(Arm7Context* ctx, u32 addr, u8 data);
	void (*write32)(Arm7Context* ctx, u32 addr, u32 data);
