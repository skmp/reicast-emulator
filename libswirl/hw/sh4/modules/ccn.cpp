...
template<u32 idx>
void CCN_QACR_write(void* that, u32 addr, u32 value)
{
...
void CCN_MMUCR_write(void* that, u32 addr, u32 value)
{
	CCN_MMUCR_type temp;
	temp.reg_data=value;
...
void CCN_CCR_write(void* that, u32 addr, u32 value)
{
	CCN_CCR_type temp;
	temp.reg_data=value;
