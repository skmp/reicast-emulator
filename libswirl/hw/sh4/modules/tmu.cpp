...
struct Sh4ModTmu_impl : Sh4ModTmu 
{
	SuperH4Mmr* sh4mmr;
	...
	//Init/Res/Term
	Sh4ModTmu_impl(SuperH4Mmr* sh4mmr) : sh4mmr(sh4mmr)
	{
		//TMU TOCR 0xFFD80000 0x1FD80000 8 0x00 0x00 Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TOCR_addr, RIO_DATA, 8);

		//TMU TSTR 0xFFD80004 0x1FD80004 8 0x00 0x00 Held 0x00 Pclk
		sh4_rio_reg(this, TMU, TMU_TSTR_addr, RIO_WF, 8, 0, STATIC_FORWARD(Sh4ModTmu_impl, write_TMU_TSTR));

		//TMU TCOR0 0xFFD80008 0x1FD80008 32 0xFFFFFFFF 0xFFFFFFFF Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCOR0_addr, RIO_DATA, 32);

		//TMU TCNT0 0xFFD8000C 0x1FD8000C 32 0xFFFFFFFF 0xFFFFFFFF Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCNT0_addr, RIO_FUNC, 32, STATIC_FORWARD(Sh4ModTmu_impl, read_TMU_TCNT<0>), STATIC_FORWARD(Sh4ModTmu_impl, write_TMU_TCNT<0>));

		//TMU TCR0 0xFFD80010 0x1FD80010 16 0x0000 0x0000 Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCR0_addr, RIO_WF, 16, 0, STATIC_FORWARD(Sh4ModTmu_impl, TMU_TCR_write<0>));

		//TMU TCOR1 0xFFD80014 0x1FD80014 32 0xFFFFFFFF 0xFFFFFFFF Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCOR1_addr, RIO_DATA, 32);

		//TMU TCNT1 0xFFD80018 0x1FD80018 32 0xFFFFFFFF 0xFFFFFFFF Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCNT1_addr, RIO_FUNC, 32, STATIC_FORWARD(Sh4ModTmu_impl, read_TMU_TCNT<1>), STATIC_FORWARD(Sh4ModTmu_impl, write_TMU_TCNT<1>));

		//TMU TCR1 0xFFD8001C 0x1FD8001C 16 0x0000 0x0000 Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCR1_addr, RIO_WF, 16, 0, STATIC_FORWARD(Sh4ModTmu_impl, TMU_TCR_write<1>));

		//TMU TCOR2 0xFFD80020 0x1FD80020 32 0xFFFFFFFF 0xFFFFFFFF Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCOR2_addr, RIO_DATA, 32);

		//TMU TCNT2 0xFFD80024 0x1FD80024 32 0xFFFFFFFF 0xFFFFFFFF Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCNT2_addr, RIO_FUNC, 32, STATIC_FORWARD(Sh4ModTmu_impl, read_TMU_TCNT<2>), STATIC_FORWARD(Sh4ModTmu_impl, write_TMU_TCNT<2>));

		//TMU TCR2 0xFFD80028 0x1FD80028 16 0x0000 0x0000 Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCR2_addr, RIO_WF, 16, 0, STATIC_FORWARD(Sh4ModTmu_impl, TMU_TCR_write<2>));

		//TMU TCPR2 0xFFD8002C 0x1FD8002C 32 Held Held Held Held Pclk
		sh4_rio_reg(this, TMU, TMU_TCPR2_addr, RIO_FUNC, 32, STATIC_FORWARD(Sh4ModTmu_impl, TMU_TCPR2_read), STATIC_FORWARD(Sh4ModTmu_impl, TMU_TCPR2_write));

		for (int i = 0; i < 3; i++) {
			tmu_sched[i] = sh4_sched_register(this, i, STATIC_FORWARD(Sh4ModTmu_impl, sched_tmu_cb));
...
Sh4ModTmu* Sh4ModTmu::Create(SuperH4Mmr* sh4mmr) {
	return new Sh4ModTmu_impl(sh4mmr);
}