...
LIBRETRO_PROXY_STUB_TYPE void  retro_run(void) {
    ...
    g_gl_bound_render_frame_buffer = hw_render.get_current_framebuffer();
    //if (g_gl_bound_render_frame_buffer != g_previous_bound_rfb) {
        glBindFramebuffer(RARCH_GL_FRAMEBUFFER, g_gl_bound_render_frame_buffer);
       // g_previous_bound_rfb = g_gl_bound_render_frame_buffer;
   // }
